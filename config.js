...
const SUDO = process.env.SUDO || '2348163137129';
...
const URL = process.env.URL || "https://chat.whatsapp.com/BlgFAVAC4Cv5NpcQ8CscW8";
...
const WORK_TYPE = process.env.WORK_TYPE || 'self';
